...
export const popupHeadingPlaceImage = document.querySelector(".popup__heading_place_image"); // текст подписи модального окна картинки
export const popupImageItem = document.querySelector(".popup__image");                       // изображение в модальном окне картинки
